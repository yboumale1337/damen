...
# Frontend Mentor - Damin landing page

![Design preview for the Damin landing page coding challenge](./design/desktop-preview.jpg)
...
- Change the `fill` and `stroke` color of the SVGs at specific points (the challenge can be completed using the single `logo-Damin.svg` file provided)
